...
# Area to use code to answer your questions.
...
names(cnts)
names(cnts)[1] <- "blank" # there is no label for the 1st item.
...
plot(data$Weight, data$Height, # 2 numerical
     pch = 19,
     col = data$Offer.Sent, # 1 categorical
     xlab = "Weight (lbs)",
     ylab = "Height (in)")
