...
# Note: 
mascot.data <- read_xlsx("../Control_Flow_and_Functions/data/NCSU_Mascots_v1.xlsx")
...
write_xlsx(mascot.data[1:20, ], "../Control_Flow_and_Functions/output/mascot_20.xlsx")
